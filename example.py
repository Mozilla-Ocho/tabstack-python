...
tabs = TABStack(api_key=os.getenv("TABSTACK_API_KEY", "your-api-key-here"))

# Example 1: Extract markdown from a URL
print("Example 1: Extract Markdown")
print("-" * 50)
try:
    result = tabs.extract.markdown(url="https://example.com/blog/article", metadata=True)
...
try:
    ...
    result = tabs.extract.json(url="https://news.ycombinator.com", schema=schema)
