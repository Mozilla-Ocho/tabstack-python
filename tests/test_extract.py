...
from tabstack.types import JsonResponse, MarkdownResponse, Metadata, SchemaResponse
...
class TestExtractMarkdown:
    ...
    async def test_markdown_without_metadata(
        ...
        mock_http.post.assert_called_once_with(
            ...
            data={"url": "https://example.com", "metadata": False, "nocache": False},
        )
    ...
    async def test_markdown_with_nocache(self, mocker: Any) -> None:
        ...
        mock_http.post.assert_called_once_with(
            "/api/extract/markdown",
            data={"url": "https://example.com", "metadata": False, "nocache": True},
        )
...
class TestExtractSchema:
    ...
    async def test_schema_with_nocache(self, mocker: Any) -> None:
        ...
        assert call_args[1]["data"]["nocache"] is True
